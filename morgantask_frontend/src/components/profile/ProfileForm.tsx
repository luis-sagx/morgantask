...
export default function ProfileForm({ data } : Readonly<ProfileFormProps>) {
    ...
    return (
        <div className="mx-auto max-w-3xl g">
            ...
            <p className="text-base font-light text-gray-500 mt-2">Aquí puedes actualizar tu información</p>

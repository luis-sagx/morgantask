...
describe('AuthAPI', () => {
  ...
  it('authenticateUser lanza error si axios response existe', async () => {
    vi.mocked(api.post).mockRejectedValue(axiosErr('login failed') as any)
  ...
  it('getUser lanza error si axios response existe', async () => {
    vi.mocked(api).mockRejectedValue(axiosErr('user failed') as any)
  ...
  it('checkPassword lanza error si axios response existe', async () => {
    vi.mocked(api.post).mockRejectedValue(axiosErr('check failed') as any)
